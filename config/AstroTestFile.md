...
- The `label` element is used to trigger the file selection when clicked.
- It displays either the selected files with their names and icons or a message prompting the user to drag and drop files.
