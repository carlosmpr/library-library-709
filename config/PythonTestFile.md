...
### External Libraries
- The code uses the `heapq` module, which provides an implementation of the heap queue algorithm (priority queue) for efficiently managing the nodes to explore based on their costs.

This code snippet efficiently demonstrates how Dijkstra's algorithm can be implemented to find the shortest path in a graph.
